// ✅ 파일 위치: src/p_member/screens/PPatterns31to40Screen.tsx
// 화원용 패턴 31-40 화면 - 완전 반응형 + 개별 버튼 위치 조정 가능
...
export default function Patterns31to40GuestScreen() {
  ...
  const handlePrevPress = () => {
    navigation.navigate("PPatterns21to30");
  };

  // 다음>> 버튼 클릭 - 41-45 패턴으로 이동
  const handleNextPress = () => {
    navigation.navigate('PPatterns41to45');
  };
  ...
  return (
    <View style={styles.container}>
      {/* 배경 이미지 
      <Image
        source={require("../../assets/images/p_member/g_patterns/p_31_40_patterns.png")}
