// ✅ 파일 위치: src/p_member/screens/PPattern48Screen.tsx
// 48번 패턴: 사용자 번호 + 최다 출현 기반 - 회원용
...
export default function PPattern48Screen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../../../assets/images/p_member/g_patterns/p_48pattern.png')} 
