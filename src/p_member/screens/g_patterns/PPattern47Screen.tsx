// ✅ 파일 위치: src/p_member/screens/PPattern47Screen.tsx
// 47번 패턴: 사용자 번호 + 최소 출현 기반 - 회원용
...
export default function PPattern47Screen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../../../assets/images/p_member/g_patterns/p_47pattern.png')} 
