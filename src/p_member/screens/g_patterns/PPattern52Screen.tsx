// ✅ 파일 위치: src/p_member/screens/PPattern52Screen.tsx
// 52번 패턴: 사용자 번호 + 주소/주민번호 기반 - 회원용
...
export default function PPattern52Screen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../../../assets/images/p_member/g_patterns/p_52pattern.png')} 
