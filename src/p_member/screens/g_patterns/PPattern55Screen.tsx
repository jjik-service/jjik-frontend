// ✅ 파일 위치: src/p_member/screens/PPattern55Screen.tsx
// 55번 패턴: 사용자 번호 + 별자리/띠 기반 - 회원용
...
export default function PPattern55Screen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../../../assets/images/p_member/g_patterns/p_55pattern.png')} 
