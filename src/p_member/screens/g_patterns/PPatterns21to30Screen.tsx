// ✅ 파일 위치: src/p_member/screens/PPatterns21to30Screen.tsx
// 회원용 패턴 21-30 화면 - 완전 반응형 + 개별 버튼 위치 조정 가능
...
export default function Patterns21to30GuestScreen() {
  ...
  const handlePrevPress = () => {
    navigation.navigate("PPatterns11to20");
  };

  // 다음>> 버튼 클릭 - 광고 시청 후 31-40 패턴으로 이동
  const handleNextPress = () => {
    setAdCompletionAction('navigateToPPatterns31to40');
    setShowAdModal(true);
  };
