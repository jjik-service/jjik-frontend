// ✅ 파일 위치: src/p_member/screens/PPattern51Screen.tsx
// 51번 패턴: 사용자 번호 + 핸드폰/생일 기반 - 회원용
...
export default function PPattern51Screen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../../../assets/images/p_member/g_patterns/p_51pattern.png')} 
