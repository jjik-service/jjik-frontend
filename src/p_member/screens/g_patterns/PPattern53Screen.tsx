// ✅ 파일 위치: src/p_member/screens/PPattern53Screen.tsx
// 53번 패턴: 사용자 번호 + 사주/음양오행 기반 - 회원용
...
export default function PPattern53Screen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../../../assets/images/p_member/g_patterns/p_53pattern.png')} 
