// ✅ 파일 위치: src/p_member/screens/PPattern50Screen.tsx
// 50번 패턴: 사용자 번호 + 최근 제외 번호 기반 - 회원용
...
export default function PPattern50Screen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../../../assets/images/p_member/g_patterns/p_50pattern.png')} 
