...
export default function Patterns41to45GuestScreen() {
  ...
  const handlePrevPress = () => {
    navigation.navigate("PPatterns31to40");
  };

  // 다음>> 버튼 클릭 - 광고 시청 후 46-55 패턴으로 이동 (임시로 홈으로)
  const handleNextPress = () => {
    setAdCompletionAction('navigateToPPatterns46to55');
    setShowAdModal(true);
  };
  ...
  const handleAdComplete = () => {
    ...
    switch (adCompletionAction) {
      ...
      case 'navigateToPatterns46_55':
        ...
        navigation.navigate('PPatterns46to55');
        break;
      default:
        break;
    }
  ...
  return (
    <View style={styles.container}>
      {/* 배경 이미지 */}
      <Image
        source={require("../../assets/images/p_member/g_patterns/p_41_45_patterns.png")}
