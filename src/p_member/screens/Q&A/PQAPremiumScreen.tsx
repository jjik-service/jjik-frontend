// ✅ 파일 위치: src/p_member/screens/PQAPremiumScreen.tsx
// 회원용 Q&A 프리미엄/결제 화면
...
export default function QAPremiumGuestScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 
      <Image
        source={require("../../../../assets/images/p_member/Q&A/p_Q&A_pay.png")}
      ...
      {expandedItems.includes(1) && (
        <View style={[styles.answerContainer, styles.q1Answer]}>
          <Text style={styles.answerText}>프리미엄 요금제는 월 9,900원입니다.</Text>
        </View>
      )}
      ...
      {expandedItems.includes(2) && (
        <View style={[styles.answerContainer, styles.q2Answer]}>
          <Text style={styles.answerText}>결제는 카드, 계좌이체, 간편결제가 가능합니다.</Text>
        </View>
      )}
      ...
      {expandedItems.includes(3) && (
        <View style={[styles.answerContainer, styles.q3Answer]}>
          <Text style={styles.answerText}>환불은 이용약관에 따라 부분 환불 가능합니다.</Text>
        </View>
      )}
      ...
      {expandedItems.includes(4) && (
        <View style={[styles.answerContainer, styles.q4Answer]}>
          <Text style={styles.answerText}>무료체험은 7일간 제공됩니다.</Text>
        </View>
      )}
      ...
      {expandedItems.includes(5) && (
        <View style={[styles.answerContainer, styles.q5Answer]}>
          <Text style={styles.answerText}>구독료 환불이 가능합니다.</Text>
        </View>
      )}
      ...
      {expandedItems.includes(6) && (
        <View style={[styles.answerContainer, styles.q6Answer]}>
          <Text style={styles.answerText}>결제 영수증은 이메일로 발송됩니다.</Text>
        </View>
      )}
      ...
      {expandedItems.includes(7) && (
        <View style={[styles.answerContainer, styles.q7Answer]}>
          <Text style={styles.answerText}>결제 오류가 발생하면 고객센터로 문의하세요.</Text>
        </View>
      )}
