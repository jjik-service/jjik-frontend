// ✅ 파일 위치: src/p_member/screens/PQAInquiryScreen.tsx
// 회원용 Q&A 1:1 문의하기 화면
...
const styles = StyleSheet.create({
  ...
  // 카테고리 선택 버튼 - 위치 수정됨
  categoryButton: {
    top: 560 * (height / DESIGN_HEIGHT),
    left: 15 * (width / DESIGN_WIDTH),
    width: 520 * (width / DESIGN_WIDTH),
  ...
  // 제목 입력창 - 위치 수정됨
  subjectInput: {
    top: 695 * (height / DESIGN_HEIGHT),
    left: 43 * (width / DESIGN_WIDTH),
    width: 1010 * (width / DESIGN_WIDTH),
    height: 130 * (height / DESIGN_HEIGHT),
    paddingVertical: 20 * (height / DESIGN_HEIGHT),
    borderWidth: 1,
    borderColor: "#000000", // 개발용 노란색 외곽선
  },

  // 문의 내용 입력창 - 위치 수정됨
  contentInput: {
    top: 835 * (height / DESIGN_HEIGHT),
    left: 40 * (width / DESIGN_WIDTH),
    width: 1010 * (width / DESIGN_WIDTH),
    height: 420 * (height / DESIGN_HEIGHT),
  ...
  // 연락처 휴대폰 입력창 - 위치 수정됨
  phoneInput: {
    top: 1375 * (height / DESIGN_HEIGHT),
    left: 40 * (width / DESIGN_WIDTH),
    width: 1010 * (width / DESIGN_WIDTH),
    height: 110 * (height / DESIGN_HEIGHT),
    paddingVertical: 15 * (height / DESIGN_HEIGHT),
    borderWidth: 1,
    borderColor: "#000000", // 개발용 노란색 외곽선
  },
