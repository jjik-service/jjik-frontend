// ✅ 파일 위치: src/screens/guest/screens/Pattern48GuestScreen.tsx
// 48번 패턴: 사용자 번호 + 최다 출현 기반 - 게스트용
...
export default function Pattern48GuestScreen() {
    ...
    try {
      ...
      const response = await fetch('/api/generate', {
        ...
        body: JSON.stringify({
          ...
          user_excludes: excludeArray, // ✅ 올바른 파라미터명
          calendar_type: "solar"
        }),
      });
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 
      <Image 
        source={require('../../../../assets/images/guest/patterns/pattern48_guest.png')} 
...
const styles = StyleSheet.create({
  ...
  // ✅ 공통 입력창 스타일 - 47번과 동일하게 (노란색 외곽선 추가)
  numberInput: {
    position: 'absolute',
  ...
  // ✅ 설명/생성번호 표시 영역 (47번과 동일, 노란색 외곽선 추가)
  displayArea: {
    position: 'absolute',
    top: scaleHeight(595),
    left: scaleWidth(213),
