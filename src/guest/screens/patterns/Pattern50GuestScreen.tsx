// ✅ 파일 위치: src/screens/guest/screens/Pattern50GuestScreen.tsx
// 50번 패턴: 사용자 번호 + 최근 제외 번호 기반 - 게스트용
// 고정번호/제외번호 입력창 4개씩 + 백엔드 API 연동
...
export default function Pattern50GuestScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 
      <Image 
        source={require('../../../../assets/images/guest/patterns/pattern50_guest.png')} 
