// ✅ 파일 위치: src/screens/guest/screens/Pattern49GuestScreen.tsx
// 49번 패턴: 사용자 번호 + 랜덤 기반 - 게스트용
...
export default function Pattern49GuestScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 */}
      <Image 
        source={require('../../assets/images/pages/patterns/pattern49_guest.png')} 
