// ✅ 파일 위치: src/screens/guest/screens/Pattern54GuestScreen.tsx
// 54번 패턴: 사용자 번호 + 이름(한글한자영문) 기반 - 게스트용
...
export default function Pattern54GuestScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* ✅ 배경 이미지 
      <Image 
        source={require('../../assets/images/pages/patterns/pattern54_guest.png')} 
